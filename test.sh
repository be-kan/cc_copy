...
try 2 'int _main() { int a; a=2; return a; }'
try 10 'int _main() { int a; a=2; int b; b=3+2; return a*b; }'
...
try 60 'int _main() { int sum; sum=0; int i; for (i=10; i<15; i=i+1) sum = sum + i; return sum;}'
try 89 'int _main() { int i; int j; int k; int m; i=1; j=1; for (k=0; k<10; k=k+1) { m=i+j; i=j; j=m; } return i;}'
